...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task3/reg_file1r1w/module/Reg_file1R1W_FDRE_reg_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reg_file1R1W_FDRE_reg_unit_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reg_file1R1W_FDRE_reg_unit_module.tcl

...
ISEStep( "vivado",
         "-log Reg_file1R1W_FDRE_reg_unit_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Reg_file1R1W_FDRE_reg_unit_module.tcl -notrace" );

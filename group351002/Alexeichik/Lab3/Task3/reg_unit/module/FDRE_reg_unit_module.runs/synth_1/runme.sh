...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task3/reg_unit/module/FDRE_reg_unit_module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FDRE_reg_unit_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FDRE_reg_unit_module.tcl

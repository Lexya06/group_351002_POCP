...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task3/reg_unit/module/FDRE_reg_unit_module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FDRE_reg_unit_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FDRE_reg_unit_module.tcl -notrace

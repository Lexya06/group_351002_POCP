...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task6/module/pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_module.tcl

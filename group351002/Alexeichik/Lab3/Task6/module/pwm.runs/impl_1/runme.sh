...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task6/module/pwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_module.tcl -notrace

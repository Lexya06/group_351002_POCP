...
ISEStep( "vivado",
         "-log Reg_file2R1W_FDCE_reg_unit_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Reg_file2R1W_FDCE_reg_unit_module.tcl -notrace" );

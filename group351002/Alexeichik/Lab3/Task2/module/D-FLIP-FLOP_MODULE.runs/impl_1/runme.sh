...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task2/module/D-FLIP-FLOP_MODULE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DFFAR_MODULE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DFFAR_MODULE.tcl -notrace

...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task1/module/RSLATCH_MODULE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RSLATCH_MODULE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RSLATCH_MODULE.tcl -notrace

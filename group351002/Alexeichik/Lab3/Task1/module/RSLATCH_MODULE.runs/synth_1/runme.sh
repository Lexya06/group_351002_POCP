...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task1/module/RSLATCH_MODULE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RSLATCH_MODULE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RSLATCH_MODULE.tcl

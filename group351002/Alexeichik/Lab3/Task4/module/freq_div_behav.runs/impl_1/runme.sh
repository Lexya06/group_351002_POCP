...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task4/module/freq_div_behav.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log freq_div_behav_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source freq_div_behav_module.tcl -notrace

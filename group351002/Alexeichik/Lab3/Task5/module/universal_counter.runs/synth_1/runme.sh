...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task5/module/universal_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_counter_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source universal_counter_module.tcl

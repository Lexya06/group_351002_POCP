...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab3/Task5/module/universal_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_counter_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source universal_counter_module.tcl -notrace

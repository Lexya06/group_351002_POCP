...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab1/Task7/transform_to_berger_code_from_mux2_and_invertors.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log to_berger_transfom_structural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source to_berger_transfom_structural.tcl

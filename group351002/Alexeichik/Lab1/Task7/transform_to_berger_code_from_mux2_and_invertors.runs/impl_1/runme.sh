...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab1/Task7/transform_to_berger_code_from_mux2_and_invertors.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log to_berger_transfom_structural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source to_berger_transfom_structural.tcl -notrace

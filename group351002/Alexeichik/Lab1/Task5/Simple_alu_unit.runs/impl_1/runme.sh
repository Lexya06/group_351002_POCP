...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab1/Task5/Simple_alu_unit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_unit_package.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_unit_package.tcl -notrace

...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab1/Task5/Simple_alu_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_unit_package.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_unit_package.tcl

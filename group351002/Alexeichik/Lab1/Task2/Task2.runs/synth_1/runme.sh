...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab1/Task2/Task2/Task2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Switch_led_commut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Switch_led_commut.tcl

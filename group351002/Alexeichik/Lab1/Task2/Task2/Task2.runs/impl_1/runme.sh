...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab1/Task2/Task2/Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Switch_led_commut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Switch_led_commut.tcl -notrace

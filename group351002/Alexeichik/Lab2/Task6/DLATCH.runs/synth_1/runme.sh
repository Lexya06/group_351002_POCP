...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab2/Task6/DLATCH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SYNTHES_DLATCH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SYNTHES_DLATCH.tcl

...
HD_PWD='C:/Users/ASUS/Desktop/Vivado_tasks/Lab2/Task4/module/Comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CMP3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CMP3.tcl -notrace
